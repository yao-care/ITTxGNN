...
import pandas as pd
from ittxgnn.collectors import DrugBundleAggregator
from ittxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from ittxgnn.collectors.drug_bundle import PredictedIndication
    from ittxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from ittxgnn.collectors.drug_bundle import DrugBundle
