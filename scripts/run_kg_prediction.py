...
from ittxgnn.data import load_fda_drugs, filter_active_drugs
from ittxgnn.mapping import (
    map_fda_drugs_to_drugbank,
    map_fda_indications_to_diseases,
    get_mapping_stats,
    get_indication_mapping_stats,
)
from ittxgnn.predict import find_repurposing_candidates, generate_repurposing_report


def main():
    print("=" * 60)
    print("知識圖譜方法 - Italy藥品老藥新用預測")
    print("Predizione di Riposizionamento dei Farmaci in Italia")
    print("=" * 60)
    print()
